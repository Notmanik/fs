...
const Inventory = () => {
  ...
  const ctaRoles = ['inventory','stock','supply','warehousing','fulfillment','availability','operations'];
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
             Manual inventory management leads to costly mistakes
            </Typography>
            <Typography
                variant="body1"
                sx={{
                ...
                >
                Odoo Inventory gives you complete control over your warehouse operations by allowing you to create and manage detailed storage locations such as aisles, shelves, pallet racks, and cold storage areas. This structure improves traceability and ensures products are always stored and retrieved efficiently.
                ...
                >
                Dedicated dashboards keep fulfillment, purchasing, picking, packing, receiving, and quality teams aligned with their daily tasks. The system automatically prioritizes tasks based on deadlines, helping ensure on-time deliveries and smooth warehouse operations even during high-volume periods.
            ...
            >
              Barcode scanning streamlines every warehouse action, from receipts to inventory adjustments, using industry standards like GS1, EAN13, and EAN14. Real-time forecasting provides visibility into on-hand, incoming, and outgoing stock, while full product traceability tracks each item’s journey from supplier to customer.
