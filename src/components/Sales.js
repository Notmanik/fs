...
import odooVideo from '../content/Odoo Sales.mov';

const Sales = () => {
  // CTA section role animation
  const ctaRoles = ['sales','deals','conversions','revenue','pipeline','orders','growth'];
    ...
    <Box>
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          Create clean, professional, and interactive quotations instantly with our powerful quotation builder.
          </Typography>
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
             Sales pipelines break without visibility
            </Typography>
            <Typography
                variant="body1"
                sx={{
                ...
                >
               Odoo Sales simplifies the entire sales process, from quotation to invoicing, within a single platform. Sales teams can send professional quotes in just a few clicks and convert them into sales orders and invoices directly from the same screen, ensuring speed and consistency throughout the sales cycle.
Quotations can be created instantly using predefined products, price lists, and templates, ensuring accurate pricing every time. 
                ...
                >
                The system automatically applies the correct prices, discounts, and taxes, helping businesses maintain control while scaling their sales operations.
                </Typography>
            <Typography
              variant="body1"
              sx={{
            ...
            >
              Customers benefit from a self-service online portal where they can view quotes, confirm orders, track deliveries in real time, and even make changes if allowed. Orders can be confirmed using electronic signatures or online payments, while built-in dashboards provide clear insights into KPIs such as revenue, churn, MRR, and customer lifetime value.
