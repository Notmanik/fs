    ...
    <Box>
      ...
      >
        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          Experience limitless marketing possibilities with fully-automated, user-friendly, and self-sufficient workflows.
          </Typography>
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
             Marketing efforts fail without automation
            </Typography>
            <Typography
                variant="body1"
                sx={{
                ...
                >
                Odoo Marketing enables businesses to create automated, targeted campaigns that scale effortlessly. By automating workflows and customer journeys, you can engage prospects consistently and nurture them through the sales funnel without manual intervention.
                ...
                >
                Advanced segmentation tools ensure that the right message reaches the right audience at the right time. Marketing workflows are built around prospect behavior, allowing campaigns to react automatically based on actions such as email opens, clicks, or website visits.
            ...
            >
              {[
                'Automated, always-on Marketing',
                'Targeted Campaigns With Smart Segmentation',
                'Visual, Easy-to-Build Customer Journeys',
                'Fully Integrated Lead Generation and Nurturing',
              ].map((item, i) => (
                <Box
                  key={i}
                  sx={{
            ...
            >
             Campaign creation is simple and flexible, with multi-stage workflows that can be built in just a few steps. A powerful drag-and-drop editor allows full control over email design and content, while predefined building blocks help create professional layouts without any coding. Automated actions can move leads forward, assign them to sales teams, or update records seamlessly.
            </Typography>
          </Box>
        </Container>
      </Box>
