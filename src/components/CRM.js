      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            >
             Sales teams lose deals due to poor follow-ups
            </Typography>
            <Typography
                variant="body1"
                sx={{
                ...
                >
                Odoo CRM offers an intuitive and easy-to-use interface that gives you a clear overview of all your sales activities. Smart filters and visual pipelines help sales teams track leads, opportunities, and follow-ups efficiently, while built-in tips and best practices ensure quick and effective deployment.
                ...
                >
                Leads can be captured automatically from multiple sources such as emails, VoIP calls, social media interactions, website visits, event registrations, and support tickets. This ensures no opportunity is missed and all customer interactions are centralized in one place for better tracking and follow-up.
            ...
            >
               The opportunity pipeline is fully customizable, allowing you to define specific stages for different sales teams. With a drag-and-drop interface, teams can work faster and more collaboratively. Detailed reporting on lost opportunities helps analyze reasons for failure and continuously improve sales performance.
            </Typography>
          </Box>
        </Container>
      </Box>
            ...
            <Box sx={{ flex: 1, minWidth: '300px', position: 'relative', zIndex: 1 }}>
              ...
              >
               We build a {' '}
                ...
                that helps your team close more deals.
              </Typography>
            </Box>
